...
- Menu screen:
The Menu screen displays a list of items, and you can select and add an iten to your cart by clicking on it. You can also filter items by category (Sandwiches or Extras);
- Cart screen:
